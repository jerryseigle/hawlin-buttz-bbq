...
export default function Home() {
  return (
    ...
    //     </p>
    //     <div classNameName="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none"></div>
    //   </div>
    ...
    //   </div>
    //   <div>
    //     You will see many updates today. If you see something to change you can
    //     message me
    //   </div>
    //   <div classNameName="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left"></div>
    // </main>
  );
}
